...
<div class="space-y-2" wire:key="dashboard-people">
    @forelse ($people as $entry)
        <div class="flex items-center gap-3 rounded-md bg-white border border-stone-200 p-3 dark:bg-stone-900 dark:border-stone-800" wire:key="dashboard-person-{{ $entry['user']->id }}">
