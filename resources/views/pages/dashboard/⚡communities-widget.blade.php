...
<div class="space-y-2" wire:key="dashboard-communities-{{ $user->id }}">
    @forelse ($joined as $community)
        ...
        >
            <div class="size-11 shrink-0 overflow-hidden rounded-md bg-stone-200 dark:bg-stone-700">
    ...
    @empty
        ...
        @forelse ($suggested as $community)
            <div class="flex items-center gap-3 rounded-md bg-white border border-stone-200 p-3 dark:bg-stone-900 dark:border-stone-800" wire:key="suggested-{{ $community->id }}">
