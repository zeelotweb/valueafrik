        ...
        <main>
            <section class="mx-auto max-w-3xl px-6 py-16">
                ...
                <div class="mt-6 rounded-xl border border-dashed border-stone-300 p-6 text-sm text-stone-600 dark:border-stone-700 dark:text-stone-400">
                    ...
                    Privacy Policy will be published here before the platform is open to the public.
                    Reach out to us directly if you have questions about how your data is handled in the
                    meantime.
                </div>
            </section>
        </main>
