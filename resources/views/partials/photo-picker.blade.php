...
>
    ...
    <div class="mt-3 flex flex-wrap items-center gap-3">
        <label
            @class([
                'inline-flex cursor-pointer items-center gap-1.5 rounded-md border border-dashed border-stone-300 px-3 py-1.5 text-sm font-medium text-stone-600 transition hover:border-stone-500 hover:text-stone-900 dark:border-stone-700 dark:text-stone-400 dark:hover:border-stone-400 dark:hover:text-white',
        ...
        <span x-show="uploading" style="display: none;" class="flex items-center gap-1.5 text-sm text-stone-600 dark:text-stone-400">
